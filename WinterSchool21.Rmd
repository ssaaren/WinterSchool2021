...
top.5000 <- order(Matrix::rowSums(GetAssayData(se.subset,assay ="RNA")),
                  decreasing = TRUE)[1:5000]

top.5000 <- rownames(se.subset)[top.5000]
...
*Q9* : Create a data frame called `top.2.genes` with the *top 2* genes of each
